export const blogPosts = [
    {
        date: "2025-10-06",
        title: "Generating Scalable SVG Maps from GeoJSON Data",
        body: "I recently had fun working on a creative project that generates scalable and functional SVG maps from GeoJSON files. It started when I needed a neighborhood map of Seattle for a project and couldn’t find one that fit what I was looking for. That led me to build a tool that could transform any GeoJSON file into a usable SVG. Once I added color customization, the maps became both functional and beautiful — I couldn’t stop experimenting with new cities. Along the way, I learned a lot about SVG structure, mathematical mapping, and coordinate scaling to achieve accurate visual outputs. It was a rewarding mix of art, math, and code, and hopefully others will find the tool useful for their own projects."
    },
    {
        date: "2025-08-10",
        title: "Vibe Coding My First Website",
        body: "I recently challenged myself to vibe code my first full website — letting AI take the lead on scaffolding things while I guided the overall structure and logic. At first, it was fun to just flow with the AI’s momentum.But as the project grew in complexity, I had to step in as a real dev again — cleaning things up, DRYing out code, defining reusable components, and putting proper boundaries in place.I also had to design layers of authentication and decide what data should actually be public. Setting up the dev and production environments came with their fair share of head- scratchers too.But once everything was running smoothly, I was impressed by how much faster I could move. This was also my first project using Tailwind, and I loved how AI filled in classes and helped me see design possibilities instantly.It even assisted in defining SQL tables and generating sample data — which really helped me see the project come to life early on. In the end, my project still needed me — my judgment, structure, and problem - solving — but it was a blast to work with the AI and get to a working product so much faster."
    },
    {
        date: "2025-08-04",
